...
//		fprintf(file,"POINT_DATA\t%d\n",points);
        ...
        if(pfile!=NULL) {
            ...
            fprintf(file,"\n");
            fprintf(file,"SCALARS phi float\n");
            fprintf(file,"LOOKUP_TABLE default\n");
            for(i=0;i<points;i++){
                fprintf(file,"\t%e\n",phi[i]);
            }
