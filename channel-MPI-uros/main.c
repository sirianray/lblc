...
int newrun_on, wall_x, wall_y, wall_z, flow_on, Q_on, debug_on, patch_on, field_on, T_on;
...
double dt=1.0, qdt, tau_f, itau_f, L1, L2, L3, L4, xi, xi1, xi2, Gamma_rot, rho, S_lc, Aldg, a_ldg, delT, B_ldg, C_ldg, Temp=third, e[15][3], q_init;
double q_ch, twqL_ch;
