...
extern int newrun_on, wall_on, flow_on, Q_on, debug_on;
...
extern double dt, qdt, tau_f, itau_f, kappa, xi, xi1, xi2, Gamma_rot, rho, yforce, U_lc, S_lc, A_ldg, Temp, e[15][3];
extern double uy_top, uy_bottom;
extern double qthreshold, uthreshold, k_eng, Q_diff, e_toto, e_tot, e_ld, e_el, e_sf;
extern double W_top, W_bot, n_top[3], n_bot[3];

extern int *neighbor, *nextf, *info;
extern real *Q, *H, *surf, *vsurf;
