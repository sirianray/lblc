...
extern int newrun_on, wall_on, flow_on, Q_on, debug_on, patch_on;
...
extern double dt, qdt, tau_f, itau_f, kappa, xi, xi1, xi2, Gamma_rot, rho, U_lc, S_lc, A_ldg, Temp, e[15][3];
...
extern int type_patch;
extern double W_patch, patchx, patchy, patchz;
...
extern int point, lpoint, qpoint, mpoint, node, nodes;
