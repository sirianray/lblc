...
int newrun_on, wall_x, wall_y, wall_z, flow_on, Q_on, debug_on, patch_on, patt_on;
...
double ux_lo, uy_lo, uz_lo, ux_hi, uy_hi, uz_hi, xforce, yforce, zforce, fr;
...
double zeta, zetai, zetao;

int *neighb, *nextf, *info, *neighbsurf;
real *Q, *H, *surf, *Qsurf, *Hsurf;
real *Rho, *u, *W, *f, *p, *f2, *Cf, *sigma_q, *sigma_p, *patt_c;

int myid=0, numprocs=1;
MPI_Win winq, wins, winr, winu, winf, winf2, winp, winQsurf, winHsurf, winneighbsurf, winsurf, winnf, wininfo, winneighb, winpatt_c;
MPI_Comm shmcomm;
