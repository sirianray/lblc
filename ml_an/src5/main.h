...
extern int newrun_on, wall_x, wall_y, wall_z, flow_on, Q_on, debug_on, patch_on, patt_on;
...
extern double dt, qdt, tau_f, itau_f, L1, L2, L3, L4, xi, xi1, xi2, Gamma_rot, rho, U_lc, S_lc, A_ldg, Temp, e[15][3], q_init;
extern double q_ch, twqL_ch;
extern double k_eng, Q_diff, e_toto, e_tot, e_ld, e_el, e_sf, Fld0, e_L1, e_L2, e_L3, e_L4;
//extern double ux_top, ux_bot, uy_top, uy_bot, xforce, yforce, zforce;
extern double ux_lo, uy_lo, uz_lo, ux_hi, uy_hi, uz_hi, xforce, yforce, zforce, fr; 
...
extern double zeta, zetai, zetao;         // activity

extern int *neighb, *nextf, *info, *neighbsurf;
extern real *Q, *H, *surf, *Qsurf, *Hsurf;
extern real *Rho, *u, *W, *f, *p, *f2, *Cf, *sigma_q, *sigma_p, *patt_c;

extern int myid, numprocs;
extern MPI_Win winq, wins, winr, winu, winf, winf2, winp, winQsurf, winHsurf, winneighbsurf, winsurf, winnf, wininfo, winneighb, winpatt_c;
...
void cal_stress();
void cal_stress2();     // would eventually replace cal_stress()
void cal_sigma_p();
void monitor();
void write_restart();
void read_restart();
